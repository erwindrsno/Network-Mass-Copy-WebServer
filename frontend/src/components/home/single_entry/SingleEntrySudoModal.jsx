        ...
        <div class="w-2/5 border rounded-lg bg-gray-50 border-gray-300 shadow-md">
          <div class="flex flex-col my-2 mx-3 gap-4">
            ...
            <div class="flex flex-col gap-3 items-center rounded-lg p-2 bg-gray-50">
              <Show when={isCopy()} fallback={<p class="text-center">Anda akan melakukan <span class="text-red-500 font-semibold">pengalihan hak akses direktori</span> dengan keterangan:</p>}>
                <p>Anda akan melakukan <span class="text-red-500 font-semibold">penyalinan direktori</span> beserta file dengan keterangan:</p>
              </Show>
              ...
              <form onSubmit={event =>
                props.authSudoAction(event, token, entryId, isCopy, props.closeModal, directory)} class="flex flex-col gap-2">
